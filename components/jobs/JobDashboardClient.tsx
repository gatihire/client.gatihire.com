...
function CandidateProfileModal({ candidate, application, jobId, jobTitle, stages, onStageChange, onClose, detailsCache, onUnlock, unlocking }: {
  ...
  onUnlock?: (id: string) => void; unlocking?: boolean;
}) {
  ...
  const handleLockedAction = (e: React.MouseEvent, type: string) => {
    if (candidate.is_unlocked === false) {
      e.preventDefault()
      if (confirm(`Unlock this profile to access ${type}? This will use 1 profile unlock credit.`)) {
      ...
      >
        ...
        <div style={{ padding: "28px 28px 20px", borderBottom: "1px solid var(--line)" }}>
          <div style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
            <div style={{
              width: 64, height: 64, borderRadius: "50%", background: candidate.is_unlocked !== false ? "#22c55e" : "#059669",
            ...
            <div style={{ flex: 1 }}>
              <h3 style={{ fontSize: 20, fontWeight: 800, color: "var(--bright)", margin: 0, display: "flex", alignItems: "center", gap: 8 }}>
                {candidate.is_unlocked !== false ? (candidate.name || "Unknown") : (candidate.initials || candidate.name || "Unknown")}
              </h3>
          ...
          <div style={{ display: "flex", gap: 8, marginTop: 14 }}>
            <a href={whatsappUrl} target="_blank" rel="noopener" onClick={(e) => handleLockedAction(e, "WhatsApp")} style={{
              display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", borderRadius: 8,
              background: "#25D366", color: "#fff", fontSize: 12, fontWeight: 700, textDecoration: "none", border: "none", cursor: "pointer",
            }}>
              <IconWhatsApp /> WhatsApp
            </a>
            <a href={emailUrl} onClick={(e) => handleLockedAction(e, "Email")} style={{
              display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", borderRadius: 8,
            ...
            <a href={callUrl} onClick={(e) => handleLockedAction(e, "Call")} style={{
              display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", borderRadius: 8,
              background: "#fff", color: "var(--secondary)", fontSize: 12, fontWeight: 600, textDecoration: "none", border: "1px solid var(--line)", cursor: "pointer",
            }}>
              <IconPhone /> Call
            ...
            {candidate.file_url ? (
              <a href={candidate.file_url} target="_blank" rel="noopener" onClick={(e) => handleLockedAction(e, "Resume")} style={{
                display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", borderRadius: 8,
                background: "#fff", color: "var(--secondary)", fontSize: 12, fontWeight: 600, textDecoration: "none", border: "1px solid var(--line)", cursor: "pointer",
              }}>
                <IconFile /> Resume
              </a>
            ) : candidate.is_unlocked === false ? (
              <button onClick={(e) => handleLockedAction(e, "Resume")} style={{
                display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", borderRadius: 8,
                background: "#fff", color: "var(--secondary)", fontSize: 12, fontWeight: 600, textDecoration: "none", border: "1px solid var(--line)", cursor: "pointer",
              }}>
                <IconFile /> Resume
          ...
          {activeProfileTab === "resume" && (
            <div>
              {candidate.file_url ? (
                ...
                <div style={{ textAlign: "center", padding: 40, background: "var(--ink)", borderRadius: 10, border: "1px dashed var(--line)" }}>
                  <div style={{ fontSize: 13, color: "var(--secondary)", marginBottom: 12 }}>Unlock this profile to view the resume.</div>
                  <button onClick={(e) => handleLockedAction(e, "Resume")} disabled={unlocking} style={{
                    padding: "8px 16px", borderRadius: 8, background: "var(--gold)", color: "#fff",
                    fontSize: 12, fontWeight: 700, border: "none", cursor: unlocking ? "wait" : "pointer",
                  }}>
                  ...
                  <div onClick={(e) => e.stopPropagation()} style={{
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 20px", borderBottom: "1px solid var(--line)" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14, fontWeight: 700, color: "var(--bright)" }}>
                        <IconFile /> {candidate.file_name || "Resume"} — {candidate.is_unlocked !== false ? candidate.name : (candidate.initials || "Candidate")}
                      </div>
                      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                        <a href={candidate.file_url} target="_blank" rel="noopener" style={{
